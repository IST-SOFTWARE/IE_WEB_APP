...
const IstProductItem: FC<IProductItem> =
    ...
    //максимальная длинна title
    const maxLengthProductTitle =
        title?.length >= 24 ? `${title.slice(0, 24)}...` : title;

    return (
        <>
            {style?.inline === false || style?.inline === undefined || !style ? (
                <div className={styles.productCardVariant_Block}
                    style={{
                        margin: style.margin
                    }}
                >
                    <div className={styles.card}>
                        ...
                        <div className={styles.productInformation}>
                            <div className={styles.productTitle}>{maxLengthProductTitle}</div>
                ...
                <div className={styles.productCardVariant_Inline}
                    style={{
                        margin: style.margin
                    }}
                >
