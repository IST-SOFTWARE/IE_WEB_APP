...
interface cartCollection {
 ...
 const getCartProductDataById: cartItemGetter_fnc =
...
const CatalogTestProdsModal:FC = () => {
  ...
  const editQuantity = useCallback<quantityEditor_fnc>( async (id, newQuantity, callBack) => {
    const newCartItem = data.cartCollection_by_id.cart_model.filter((element) => {element.product_id === id})
    console.log(newCartItem)
    // await apolloClient.query({
    //   query: UPDATE_CART_BY_ID, 
    //   variables: {
