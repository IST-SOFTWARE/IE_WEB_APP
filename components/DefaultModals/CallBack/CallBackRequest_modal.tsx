...
import {IOurContacts, IOurContactsVars} from "../../../queries/landingFeatures/ourContactsQuery";
...
const CallBackRequest_modal:FC<ICallBack_Request> = (
    ...
    const{data} = useQuery<IOurContacts, IOurContactsVars>(
        getContactsQuery, {
    ...
    useEffect(()=>{
        if(data){
            ...
            if(phones){
                ...
                currentPhones.onceContact =
                phones.phone_numbers[0] ?
        ...
        <>
            ...
            {contPhones && contactsDeployed ? (
                <div className={styles.contacts_wrapper}>
                    ...
                    {/*ONE PHONE NUM*/}
                    <a
                        href={`tel:${contPhones.onceContact}`}
                    >
                        {contPhones.onceContact}
                    </a>

                    {/*CONTACTS LIST*/}
                    <div
                        className={styles.contacts_list}
                        ref={contactsList}
                    >
                        ...
                        <div className={`${styles.contact_item} ${styles.closer}`}
                            onClick={()=>{
            ...
            //    One contact bar
                ...
                <div className={styles.contacts_wrapper}>
                    <a href={`tel:${contPhones.onceContact}`}>
                        {contPhones.onceContact}
                    </a>

                    <a className={styles.moreButton}
                       onClick={()=>{setContactsDeployed(!contactsDeployed)}}
                    >
                        Контакты
                    </a>
                </div>
